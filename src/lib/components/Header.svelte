  ...
  <div>
    ...
    <nav class="nav hidden lg:block" aria-label="In-page jump links">
      <ul class="mt-[20px] w-max">
        <li><a class="group flex items-center py-2" href={`#${generateId("EHS Men's Volleyball 2024")}`}><span class="nav-text text-xs font-bold uppercase tracking-widest text-slate-500 group-hover:text-slate-200 group-focus-visible:text-slate-200">EHS Men's Volleyball 2024</span></a></li>
        <li><a class="group flex items-center py-2" href={`#${generateId("EHS Women's Volleyball 2023 Senior Night")}`}><span class="nav-text text-xs font-bold uppercase tracking-widest text-slate-500 group-hover:text-slate-200 group-focus-visible:text-slate-200">EHS Women's Volleyball 2023 Senior Night</span></a></li>
        <li><a class="group flex items-center py-2" href={`#${generateId("Portugal 2023")}`}><span class="nav-text text-xs font-bold uppercase tracking-widest text-slate-500 group-hover:text-slate-200 group-focus-visible:text-slate-200">Portugal 2023</span></a></li>
        <li><a class="group flex items-center py-2" href={`#${generateId("EHS Men's Volleyball 2023")}`}><span class="nav-text text-xs font-bold uppercase tracking-widest text-slate-500 group-hover:text-slate-200 group-focus-visible:text-slate-200">EHS Men's Volleyball 2023</span></a></li>
      </ul>
    </nav>
  </div>
